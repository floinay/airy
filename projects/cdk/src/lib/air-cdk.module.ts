...
@NgModule({
  declarations: [HideIfEmptyDirective, ClearInputBeforeUploadDirective, IndentsDirective],
  imports: [],
  exports: [HideIfEmptyDirective, ClearInputBeforeUploadDirective, IndentsDirective]
})
